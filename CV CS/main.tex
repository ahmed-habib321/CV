...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  Bachelor of Science & {\raisebox{0.0\height}{\footnotesize \faGithub}\ \textcolor{blue}{\href{https://github.com/ahmed-habib321}{ahmed-habib321}}}\\
  {Faculty of Science, Alexandria} & {\raisebox{0.0\height}{\footnotesize \faLinkedin}\ \textcolor{blue}{\href{https://www.linkedin.com/in/ahmed-habib153/}{Ahmed Habib}}}\\
  & {\raisebox{0.0\height}{\footnotesize \faFacebookSquare}\ \textcolor{blue}{\href{https://www.facebook.com/Ahmed0Habib/}{Ahmed Habib}}}\\
\end{tabularx}
}
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Bachelor of Science in Computer Science and Mathematics}{CGPA: 3.4}
...
\resumeSubHeadingListStart
    \resumeProject
      {Database Management System for bank} %Project Name
      {A java application that collect most of a bank services} %Project Name, Location Name
      {} %Event Dates

    \resumeItemListStart
        \item {Handling customers accounts , cards , depts and their actions with ATMs and the employees with the departments and branchs }
        \item {Technology Used: Java, Spring Boot}
    \resumeItemListEnd
    \vspace{-2mm}
    
    \resumeProject
      {Universal Turing Machine} %Project Name
      {A java application which check for some rule or regex in an String. } %Project Name, Location Name
      {} %Event Dates

      \resumeItemListStart
        \item {Takes the States mapping as an input then the String then shows if that String make the Machine reach to end state}
