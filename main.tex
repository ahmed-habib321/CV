...
\begin{document}
    \name{ahmed m.habib}
    \tagline{Software Developer and mathematician}
    %% You can add multiple photos on the left or right
    \photoL{4cm}{profilepic}

    \personalinfo{
        \email{ahmedhabib0660@gmail.com}\smallskip
        \whatsapp{+201228828937}
        \location{Edku, Egypt}
        \linkedin{ahmed-habib153}
        \github{ahmed-habib321}
        \facebook{Ahmed Habib}
        %\npm{npmUser}
        %\dev{devtoUser}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Experiences}
            ...
            \begin{sloppypar*}
                ...
                \cvtags{Java, Python, MySQL, Latex, Complex Analysis, Numerical Analysis, P/O-Diffrential Equations}
                \medskip

                \cvsubsection{Competent}
                \cvtags{github, HTML, CSS, Optimization Analysis}
                \medskip

                \cvsubsection{basic}
                \cvtags{JavaScript, PHP, Probability and Statistics, Number Theory, MatLab}
                \medskip
            \end{sloppypar*}
        % ----- TECH STACK -----
        ...
        \cvsection{Languages}
            ...
            \vspace*{.25cm}
            \cvlang{English}{Intermediate / B1}
    ...
    \end{comment}
        ...
        \cvsection{About Me}
            \begin{quote}
                skilled programmer and mathematician with a passion for innovation and
                problem-solving and logical thinking. Collaborative team player experienced
                in Agile methodologies. Eager to contribute and grow.
            \end{quote}
        % ----- ABOUT ME -----
        \begin{comment}
    ...
    \end{comment}
        % ----- EDUCATION -----
        \cvsection{Education}
            \cvevent{BS in Mathematics and Computer Science}{\href{https://sci.alexu.edu.eg}{Faculty of Science}}{09 2020 -- Mm YYYY}{Alexandria, Egypt}
            \begin{itemize}
                \item GPA: 3.24
            \end{itemize}
            \divider
